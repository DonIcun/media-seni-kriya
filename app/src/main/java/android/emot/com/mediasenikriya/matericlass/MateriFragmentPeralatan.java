...
import android.emot.com.mediasenikriya.MateriFragment;
...
/**
 * Created by Windows 8.1 on 18/04/2019.
 */

public class MateriFragmentPeralatan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        webView.loadUrl("file:///android_asset/peralatan.html");
